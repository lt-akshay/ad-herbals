      ...
      <div className="bg-green-700 pt-32 pb-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-green-100 mt-2 max-w-2xl">
            Learn more about AD Herbals and our mission to bring Ayurvedic products with care and commitment.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12 space-y-12">
        <section className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-600 whitespace-pre-line">
            We deal in Ayurvedic Medicines & Cosmetic Products.{"\n"}
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Ayurvedic & Natural Ingredients</li>
